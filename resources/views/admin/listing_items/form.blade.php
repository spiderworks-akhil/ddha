                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.listings.index')}}">Listings</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ route($route.'.index', [$listing->id]) }}">All
                                        Listing Items of {{$listing->listing_name}}</a></li>
                                <li class="breadcrumb-item active">@if($obj->id)Edit @else Create new @endif Listig Item
                                </li>
                            </ol>
                        </div>
                        <!--end col-->
                        ...
                        <div class="col-auto align-self-center">
                            <a class=" btn btn-sm btn-primary" href="{{route($route.'.create', [$listing->id])}}"
                                        ...
                                        <div data-simplebar>
                                            <div class="row m-0">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <select name="meida_type" class="w-100 webadmin-select2-input"
                                                        id="type-select">
                                                        <option value=""></option>
                                                        <option value="Icon" @if($obj->meida_type == 'Icon')
                                                            selected="selected" @endif>Icon</option>
                                                        <option value="Image" @if($obj->meida_type == 'Image')
                                                            selected="selected" @endif>Image</option>
                                                    </select>
                                                </div>
                                                <div class="form-group col-md-12" id="icon-div" @if(!$obj->meida_type ||
                                                    $obj->meida_type == 'Image') style="display:none;" @endif>
                                                    <label>Icon</label>
                                                    <textarea class="form-control" name="icon">{{$obj->icon}}</textarea>
                                                </div>
                                                <div class="form-group col-md-12" id="image-div" @if(!$obj->meida_type
                                                    || $obj->meida_type == 'Icon') style="display:none;" @endif>
                                                    <label>Image</label>
                                                    @include('admin.media.set_file', ['file'=>$obj->media,
                                                    'title'=>'Media Files', 'popup_type'=>'single_image',
                                                    'type'=>'Image', 'holder_attr'=>'media_id'])
                                                </div>
                                                <div class="form-group col-md-12">
