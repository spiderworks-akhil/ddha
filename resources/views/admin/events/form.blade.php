                ...
                <div class="page-title-box">
                    <div class="row">
                        ...
                        <div class="col-auto align-self-center">
                            <a class=" btn btn-sm btn-primary" href="{{route($route.'.create')}}" role="button"><i
                        ...
                        <div class="row">
                                        ...
                                        <div data-simplebar>
                                            <div class="row m-0">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <small class="text-muted">The “slug” is the URL-friendly version of
                                                        the name. It is usually all lowercase and contains only letters,
                                                        numbers, and hyphens.</small>
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label class="">Type</label>
                                                    <select name="type" id="" class="form-control">
                                                        <option value="Events" @if($obj->type =="Events") selected
                                                            @endif>Events</option>
                                                        <option value="News" @if($obj->type =="News") selected
                                                            @endif>News</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea name="location" class="form-control" rows="2"
                                                        id="location">{{$obj->location}}</textarea>
                                                </div>
                                                @endfieldshow
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <textarea name="short_description" class="form-control" rows="2"
                                                        id="short_description">{{$obj->short_description}}</textarea>
                                                </div>
                                                @endfieldshow
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea name="content" class="form-control editor"
                                                        id="content">{{$obj->content}}</textarea>
                                                </div>
                                                @endfieldshow
                                            </div>
                                        </div>
                                        ...
                                        <div class="row add-multiple-image">
                                            ...
                                            <div class="col-md-4 mb-2" id="add-new-image-wrap">
                                                <div style="display:none" id="image-clone-holder">
                                                    @include('admin.media.set_file', ['file'=>null, 'title'=>'Event
                                                    Media', 'popup_type'=>'single_image', 'type'=>'Image-Video',
                                                    'holder_attr'=>'event_medias[]', 'id'=>'id_holder'])
                                                </div>
                                                    ...
                                                    <div id="add-new-image-content">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <a class="dropdown-item" href="javascript:void(0)"
                                                                data-toggle="modal" data-target="#youtubeModal">Add
                                                                youtube link</a>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="bottom_description" class="form-control editor"
                                                id="bottom_description">{{$obj->bottom_description}}</textarea>
                                        </div>
                                        @endfieldshow
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="meta_keywords" class="form-control" rows="3"
                                                id="meta_keywords">{{$obj->meta_keywords}}</textarea>
                                        </div>
                                        @endfieldshow
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="meta_description" class="form-control" rows="3"
                                                id="meta_description">{{$obj->meta_description}}</textarea>
                                        </div>
                                        @endfieldshow
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <textarea name="og_description" class="form-control" rows="3"
                                                id="og_description">{{$obj->og_description}}</textarea>
                                        </div>
                                        @endfieldshow
                                        @fieldshow(events-extra_js)
                                        <div class="form-group col-md-6">
                                            <label class="">Extra Js</label>
                                            <textarea name="extra_js" class="form-control" rows="3"
                                                id="extra_js">{{$obj->extra_js}}</textarea>
                                        </div>
                                        @endfieldshow
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                            ...
                                            <div class="form-group w-100  mb-2">
                                                <div class="custom-control custom-switch switch-primary float-left">
                                                    <input type="checkbox" class="custom-control-input" value="1"
                                                        id="status" name="status" @if(!$obj->id || $obj->status == 1)
                                                    checked="" @endif>
                                                ...
                                                <div class="custom-control custom-switch switch-primary float-right">
                                                    <input type="checkbox" class="custom-control-input" value="1"
                                                        id="is_featured" name="is_featured" @if($obj->is_featured == 1)
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="category_id" class="w-100 webadmin-select2-input"
                                                ...
                                                <option value="{{$category->id}}" @if($category->id ==
                                                    $obj->category_id) selected="selected" @endif>{{$category->name}}
                                                </option>
                                                @include('admin._partials.category', ['category'=>$category, 'depth'=>1,
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body text-center">
                                        <a href="{{route('admin.faq.index', [$obj->id, 'Event'])}}"
                                            ...
                                            data-popup-size="large">@if(count($obj->faq)>0) Update FAQ @else Add FAQ
                                            @endif</a>
                                    </div>
                                </div>
                                @endif
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @include('admin.media.set_file', ['file'=>$obj->featured_image,
                                        'title'=>'Featured Image', 'popup_type'=>'single_image', 'type'=>'Image',
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @include('admin.media.set_file', ['file'=>$obj->banner_image, 'title'=>'Banner
                                        Image', 'popup_type'=>'single_image', 'type'=>'Image',
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        @include('admin.media.set_file', ['file'=>$obj->og_image, 'title'=>'OG Image',
                                        'popup_type'=>'single_image', 'type'=>'Image', 'holder_attr'=>'og_image_id'])
                                    </div>
                                </div>
                                @endfieldshow
                            </div>
