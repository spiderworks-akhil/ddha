    ...
    <div class="container">
        <div class="row d-flex align-items-center ">
            ...
            <div class="col-md-7">
                ...
                <p>(LOCR) is a program being offered to all the children residing in the boarding consists of two parts
                    – one part will
                    be conducted on the campus between 3pm to 4.30pm on a daily basis and the other will cover parts of
                    the valley
